...
let DemoSmartTextarea = class DemoSmartTextarea extends LitElement {
    constructor() {
        super(...arguments);
        this._text = '';
    }
...
__decorate([
    state()
], DemoSmartTextarea.prototype, "_text", void 0);
DemoSmartTextarea = __decorate([
    customElement('demo-smart-textarea')
], DemoSmartTextarea);
export { DemoSmartTextarea };
//# sourceMappingURL=demo-smart-textarea.js.map