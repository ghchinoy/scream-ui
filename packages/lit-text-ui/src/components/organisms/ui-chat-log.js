...
let UiChatLog = class UiChatLog extends LitElement {
    constructor() {
        super(...arguments);
        this.messages = [];
        this._virtualItems = [];
        this._visibleItems = [];
        this._totalHeight = 0;
        this._availableTextWidth = 0;
        // CSS matched constants
        this.FONT_STRING = "16px Inter, sans-serif";
        this.LINE_HEIGHT = 24;
        this.PADDING_Y = 24; // 12px top + 12px bottom padding inside bubble
        this.GAP = 12; // 12px gap between bubbles
    }
  ...
  `; }
    ...
    _calculateDimensions(text, currentOffset) {
        if (this._availableTextWidth <= 0)
            return { height: 100, offsetTop: currentOffset };
    ...
    _handleScroll() {
        if (!this._viewport || this._virtualItems.length === 0)
            return;
...
__decorate([
    property({ type: Array })
], UiChatLog.prototype, "messages", void 0);
__decorate([
    state()
], UiChatLog.prototype, "_virtualItems", void 0);
__decorate([
    state()
], UiChatLog.prototype, "_visibleItems", void 0);
__decorate([
    state()
], UiChatLog.prototype, "_totalHeight", void 0);
__decorate([
    query('.viewport')
], UiChatLog.prototype, "_viewport", void 0);
UiChatLog = __decorate([
    customElement('ui-chat-log')
], UiChatLog);
export { UiChatLog };
//# sourceMappingURL=ui-chat-log.js.map