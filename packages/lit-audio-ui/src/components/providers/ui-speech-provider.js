...
import { createMockAnalyser } from '../../utils/audio-utils.js';
/**
 ...
 */
let UiSpeechProvider = class UiSpeechProvider extends LitElement {
    constructor() {
        super(...arguments);
        this._context = {
            state: 'idle',
  ...
  `; }
    ...
    cancel() {
        ...
        this.dispatchEvent(new CustomEvent('speech-cancel', {
            bubbles: true,
            composed: true,
        }));
    }
...
__decorate([
    ...
    state()
], UiSpeechProvider.prototype, "_context", void 0);
__decorate([
    property({ type: String })
], UiSpeechProvider.prototype, "state", void 0);
__decorate([
    property({ type: Boolean })
], UiSpeechProvider.prototype, "simulation", void 0);
__decorate([
    property({ type: Boolean })
], UiSpeechProvider.prototype, "manual", void 0);
__decorate([
    property({ type: String })
], UiSpeechProvider.prototype, "transcript", void 0);
__decorate([
    property({ type: String })
...
export { UiSpeechProvider };
//# sourceMappingURL=ui-speech-provider.js.map