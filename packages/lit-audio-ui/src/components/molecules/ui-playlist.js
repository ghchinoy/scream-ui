 ...
 */
let UiPlaylist = class UiPlaylist extends LitElement {
    constructor() {
        super(...arguments);
        this.header = 'Queue';
        this.emptyText = 'No tracks in queue';
    }
...
], UiPlaylist.prototype, "playerState", void 0);
__decorate([
    property({ type: String })
], UiPlaylist.prototype, "header", void 0);
__decorate([
    property({ type: String })
], UiPlaylist.prototype, "emptyText", void 0);
UiPlaylist = __decorate([
    customElement('ui-playlist')
], UiPlaylist);
export { UiPlaylist };
//# sourceMappingURL=ui-playlist.js.map