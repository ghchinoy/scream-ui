 ...
 */
let UiOrb = class UiOrb extends LitElement {
    constructor() {
        super(...arguments);
  ...
  `; }
    ...
    _updateColors() {
        ...
        if (this.colors && this.colors.length === 2) {
            ...
            const primary = style.getPropertyValue('--md-sys-color-primary').trim() || '#7D56F4';
            const secondary = style.getPropertyValue('--md-sys-color-secondary').trim() || '#205';
...
__decorate([
    property({ type: Array })
], UiOrb.prototype, "colors", void 0);
__decorate([
    property({ type: String })
], UiOrb.prototype, "agentState", void 0);
__decorate([
    property({ type: Number })
], UiOrb.prototype, "inputVolume", void 0);
__decorate([
    property({ type: Number })
], UiOrb.prototype, "outputVolume", void 0);
__decorate([
    property({ type: String })
], UiOrb.prototype, "volumeMode", void 0);
__decorate([
    property({ type: Number })
], UiOrb.prototype, "seed", void 0);
__decorate([
    query('.container')
], UiOrb.prototype, "_container", void 0);
UiOrb = __decorate([
    customElement('ui-orb')
], UiOrb);
export { UiOrb };
//# sourceMappingURL=ui-orb.js.map