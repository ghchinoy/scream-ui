...
export class UiMovingGradient extends LitElement {
  ...
  @property({type: Number}) baseHeight = 0.05;
  ...
  private _mesh?: THREE.Mesh<THREE.PlaneGeometry, THREE.ShaderMaterial>;
  private _animationFrameId: number = 0;
  private _resizeObserver?: ResizeObserver;

  private _animSpeed = 1.0;
  private _curIn = 0;
  private _curOut = 0;
  private _targetColor1!: THREE.Color;
  private _targetColor2!: THREE.Color;
  private _targetColor3!: THREE.Color;
  ...
  private _updateColors() {
    if (!this._targetColor1 || !this._targetColor2 || !this._targetColor3) return;
